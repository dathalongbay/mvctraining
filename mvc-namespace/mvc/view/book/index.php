    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div style="margin: 30px 0">
                <a href="index.php?controller=book&action=create" class="btn btn-success">thêm mới sách</a>
            </div>
                ...
                if (mysqli_num_rows($books) > 0) {
                    ...
                    while($row = mysqli_fetch_assoc($books)) {
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <a class="btn btn-warning" href="index.php?controller=book&action=edit&id=<?php echo $row['id'] ?>">Sửa nhân viên</a>
                                </div>
                                <div>
                                    <a class="btn btn-danger" href="index.php?controller=book&action=delete&id=<?php echo $row['id'] ?>">Xoá nhân viên</a>
                                </div>
                            </td>
                        </tr>
                        <?php
